    ...
    private void showImage(String img){
        ...
        animator1.addListener(new Animator.AnimatorListener() {
            ...
            public void onAnimationEnd(Animator animation) {
                ...
                if (imgName == "Nobita") {
                    imageViewAll.setImageResource(R.drawable.goku);
                    Toast.makeText(MainActivity2.this, "goku", Toast.LENGTH_SHORT).show();
                }
                if (imgName == "Doraemon") {
                    imageViewAll.setImageResource(R.drawable.vegeta);
                    Toast.makeText(MainActivity2.this, "vegeta", Toast.LENGTH_SHORT).show();
                }
//                if (imgName == "All") {
